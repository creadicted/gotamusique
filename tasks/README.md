...
|---|---|---|---|
| 1-01 | [phase1/01-scaffold.md](phase1/01-scaffold.md) | todo | Go module, layout, Makefile |
| 1-02 | [phase1/02-config.md](phase1/02-config.md) | todo | INI config (server + radio presets only) |
